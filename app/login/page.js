...
export default function LoginPage() {
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-stone-50 font-sans px-4">
      ...
      >
        <div>
          <h1 className="font-serif text-xl text-blue-900">Immo famille</h1>
          <p className="text-stone-500 text-sm mt-1">Même compte que l'appli Budget famille.</p>
        </div>
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 rounded-md border border-stone-300 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
        <div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-2 rounded-md bg-blue-900 text-white text-sm font-medium hover:bg-blue-950 disabled:opacity-60"
        >
